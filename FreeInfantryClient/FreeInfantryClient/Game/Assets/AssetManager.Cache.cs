	...
	public partial class AssetManager
	{
		...
		{	// Member variables
			...
			{	//Does it exist?
				...
				{
					InfServer.Log.write(InfServer.TLog.Error, "Unable to cache asset '{0}', file was not found.", asset.filepath);
					return null;
				}
				...
				if (asset.checksum != Assets.CRC32.fileChecksum(asset.filepath))
				{
                    ...
                    {
                        InfServer.Log.write(InfServer.TLog.Error, "Checksum mismatch on asset '{0}' while attempting to cache.", asset.filepath);
                        return null;
                    }
				}
