    ...
    public class Registrar
    {
        ...
        {   //Instance some lists
            ...
            IEnumerable<Type> classes = asm.GetTypes().Where(
                type => (type.Namespace != null && type.Namespace.StartsWith("FreeInfantryClient.Game.Commands")));
        ...
        public void registerList(List<HandlerInfo> handlers)
        {
            ...
            {   //Obtain a list of appropriate handlers
                ...
                if (descriptors == null)
                {   //Report and abort
                    InfServer.Log.write(InfServer.TLog.Error, "Registrar method '{0}' did not return a list of handler descriptors.", handler.method);
                    continue;
                }
