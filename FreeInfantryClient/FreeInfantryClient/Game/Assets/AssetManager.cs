	...
	{	// Member variables
		...
		public bool load(CfgInfo zoneConf, string configFilename)
		{
			...
			{	//Missing a core file
				foreach (string missing in AssetFileFactory._missingFiles)
					InfServer.Log.write(InfServer.TLog.Error, "Missing file: {0}", missing);
				return false;
			}
        ...
        public bool grabGlobalNews(string fileUrl, string fileLocation)
        {
            ...
            catch (Exception)
            {
                ...
                {
                    InfServer.Log.write(InfServer.TLog.Warning, "Error updating global.nws, using most recent version...");
                    InfServer.Log.write(InfServer.TLog.Warning, e.ToString());
                    return false;
                }
            }
            return true;
		...
		{   //id 0 is default value of unused vehicle inventory item slots
            ...
            {
                InfServer.Log.write(InfServer.TLog.Warning, "Unable to get item by ID: {0}", id);
                return null;
            }
		...
		public ItemInfo getItemByName(string name)
		{
            ...
            {
                //InfServer.Log.write(InfServer.TLog.Warning, "Unable to get item by name: {0}", name);
                return null;
            }
		...
		public SkillInfo getSkillByID(int id)
		{
            ...
            {
                InfServer.Log.write(InfServer.TLog.Warning, "Unable to get skill by ID: {0}", id);
                return null;
            }
		...
		public SkillInfo getSkillByName(string name)
		{
            ...
            {
                InfServer.Log.write(InfServer.TLog.Warning, "Unable to get skill by name: {0}", name);
                return null;
            }
		...
		public VehInfo getVehicleByID(int id)
		{
            ...
            {
                InfServer.Log.write(InfServer.TLog.Warning, "Unable to get vehicle by ID: {0}", id);
                return null;
            }
        ...
        public VehInfo getVehicleByName(string name)
        {
            ...
            InfServer.Log.write(InfServer.TLog.Warning, "Unable to get vehicle by name: {0}", name);
            return null;
        }
		...
		public LioInfo getLioByID(int id)
		{
            ...
            {
                InfServer.Log.write(InfServer.TLog.Warning, "Unable to get LIO by ID: {0}", id);
                return null;
            }
        ...
        private void sendDataToDirectory()
        {
            ...
            {
                InfServer.Log.write(InfServer.TLog.Exception, string.Format("Data To Directory Server: {0}", e.ToString()));
            }
